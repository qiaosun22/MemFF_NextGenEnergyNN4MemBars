...
class Layer(nn.Linear):
    def __init__(self, in_features, out_features,
        ...
        #FF
        self.P = my.Linear_quant_noise(in_features, out_features, weight_bit=weight_bit, output_bit=output_bit, isint=isint, clamp_std=clamp_std, noise_scale=noise_scale, bias=False)
...
def main():
    ...
    train_loader,val_loader=F_Mnist(batchsize,10000)
